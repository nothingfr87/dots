...
set -g theme_color_scheme rose-pine 
...
alias restart-waybar "killall waybar; waybar & disown"
...
function fish_prompt
    ...
    set -l cwd_color ebbcba
    set -l git_color 524f67
    set -l time_color f6c177
    set -l prompt_color cba6f7
    set -l duration
